...
say "             You chose that model, and its name is on the permission you gave. Nothing here"
say "             depends on which AI it is. Want one you run yourself? Tell us: that is where this goes next."
say ""
