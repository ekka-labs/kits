...
say "             ${B}EKKA NEVER SAW YOUR KEYS.${N} To decide yes or no, EKKA's control plane was sent"
say "             the message to the AI and the order. Your balance and your other orders stayed here."
say "             The AI gate carried the message to the model, a third party, not EKKA."
say "             It saw only the rule, the prices, and whether you own either stock. Never your keys."
say "             ${B}Want your own model instead?${N} Add its API to your catalog the same way this kit added"
say "             Alpaca. Then the message goes to your model, not a third party's."
say ""
...
say "             ${B}EKKA NEVER SEES YOUR KEYS.${N} Neither does the AI, a third-party model, not EKKA."
say "             To decide yes or no, EKKA's control plane is sent the message to the AI and the order."
say "             Your balance and your other orders stay on this computer."
say ""
say "  ${B}Safe to try${N}"
