...
say "             ${B}EKKA NEVER SAW YOUR KEYS OR YOUR ACCOUNT.${N} It saw what the AI asked to do, and"
say "             said yes or no. The AI saw only the rule, the prices, and whether you own either stock."
say ""
...
say "             ${B}EKKA NEVER SEES YOUR KEYS OR YOUR ACCOUNT.${N} Neither does the AI."
say ""
say "  ${B}Safe to try${N}"
