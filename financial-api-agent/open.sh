...
say "  ${B}Privacy${N}    Your Alpaca keys went only to Alpaca. The AI saw only the rule, the prices, and"
say "             whether you own either stock. It never saw your keys or your account."
say ""
...
say "             The AI and EKKA never see them."
say ""
say "  ${B}Safe to try${N}"
