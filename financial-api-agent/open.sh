...
say "             ${B}EKKA NEVER SAW YOUR KEYS.${N} It saw the message to the AI and the order, because"
say "             it decided yes or no. Your balance and your other orders stayed on this computer."
say "             The AI is a third-party model, not EKKA. It saw only the rule, the prices, and whether"
say "             you own either stock. Never your keys."
