...
say "             The AI sits behind a gate. This kit used EKKA's hosted gate, which reaches a third-party"
say "             model. ${B}You can run your own gate, on your own servers, with your own model.${N} EKKA never"
say "             connects to your gate. It only says yes or no."
say ""
